...
<style>
  ...
  * {{ margin:0; padding:0; box-sizing:border-box; }}
  ...
  /* Genuine Tactile Paper Grain + Vignette Texture */
  body::after {{
  ...
  /* ---------- Tactile Archival Photo & Print Treatments ---------- */
  .ph {{
  ...
  /* Moai Heads (Wikipedia Photo with Paper Texture & Torn Edge) */
  ...
  /* Snake River Valley Photo (Ansel Adams) */
  ...
  /* Dynamic Plate Display Modes: LITHOGRAPH PULP (default), CRISP ARCHIVE, RAW PHOTO */
...
<div class="sheet">
  ...
  <div id="tab-worlds-view" class="view-panel-tab active">
    ...
    <section class="hero">
      ...
      <!-- Moai Heads (Local Wikimedia Archival Asset) -->
...
print(f"Tactile Paper Master WORLDFUL Press Application generated ({len(html_code):,} bytes)")
