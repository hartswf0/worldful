...
# Master Comprehensive Dictionary - NO PLACEHOLDERS
EXHAUSTIVE_DEFINITIONS = {
    # World 00
    "portable consequence": "The capacity of a compressed sign to travel through time and space and still reliably alter physical behavior at the receiver.",
    "lossy cut": "The unavoidable truncation that occurs when infinite physical reality is converted into a finite symbolic token, discarding 99% of local texture.",
    "trace authority": "The epistemic trust granted to a mark because it was causally produced by a physical event rather than fabricated symbolically.",
    "epistemic debt": "The latent hazard accumulated when an organization operates on simplified abstractions while forgetting what was omitted during compression.",
    
    # World 01
    "deixis": "The foundational linguistic act of pointing and orienting shared bodily attention before words or formal syntax can occur.",
    "salience monopoly": "The political or institutional control over what an audience is permitted or forced to look at within a shared visual field.",
    "pre-semantic orientation": "The pre-linguistic alignment of heads, gaze, and bodies toward a target, upon which all subsequent meaning depends.",
    "attention feudalism": "A social structure where sovereign power is exercised not by dictating beliefs, but by monopolizing and capturing the direction of collective gaze.",
    
    # World 02
    "heritage technical debt": "The preservation of obsolete architectural, linguistic, or institutional features whose original physical justification has vanished.",
    "path dependence": "The systemic inertia that forces present decisions to follow historical precedent, even when the original rationale is completely obsolete.",
    "doctrinal residue": "A sacred ritual, legal clause, or procedure that continues to be practiced purely because it exists, divorced from its causal origin.",
    "legacy invariant": "An operational rule or interface constraint retained exclusively for backward compatibility with forgotten legacy systems.",
    
    # World 03
    "horizontal transfer": "The lateral borrowing and mutation of cultural symbols, tools, and myths across disparate groups without genealogical purity.",
    "hybrid vigor": "The increased survival and explanatory fitness of conceptual models formed by crossing incompatible cultural lineages.",
    "pedigree myth": "The false institutional belief that an effective idea, law, or lineage descended from a single pure, unbroken ancestral origin.",
    "lineage genome": "The underlying composite code of borrowed tropes and operational mechanisms that constitute an apparently original cultural tradition.",
    
    # World 04
    "pre-enactment": "The mental or symbolic rehearsal of danger that trains neuromuscular and cognitive reflexes prior to physical exposure.",
    "simulation drift": "The dangerous divergence between a protective mental model or virtual testbed and the evolving physical reality it simulates.",
    "anticipatory hardware": "Narratives, rituals, and fables that function as survival firmware by storing past survival lessons in memorable forms.",
    
    # World 05
    "counts-as rule": "The formula 'X counts as Y in context C' (Searle) that transforms physical objects into institutional realities carrying deontic power.",
    "institutional reality": "Facts that exist purely because of collective agreement, status functions, and shared enforcement, such as money, property, and law.",
    "deontic power": "Rights, duties, authorizations, and obligations created by institutional status functions that alter what bodies are permitted to do.",
    "reification": "The cognitive error of treating a socially constructed status function as an inherent physical property of an object.",
    
    # World 06
    "observational noise": "The proliferation of high-resolution telemetry and pixel capture that obscures the underlying causal meaning of an event.",
    "high-resolution blindness": "The failure to comprehend a phenomenon despite capturing petabytes of descriptive data, because telemetry is mistaken for understanding.",
    "telemetry fetishism": "The mistaken belief that measuring every surface variable guarantees control over the underlying systemic consequence.",
    
    # World 07
    "administrative ontology": "The rigid categorization schema imposed by forms and database tables that forces reality to fit predetermined bureaucratic slots.",
    "formulary sovereignty": "The power of an intake form or data model to render anything outside its input fields legally, operationally, or financially non-existent.",
    "schema cannibalism": "The institutional process by which nuanced human grief and complex physical conditions are mutilated to fit standard database fields.",
    
    # World 08
    "continuous gradient": "The natural, unbroken ecological or spatial spectrum that resists sharp categorical or jurisdictional boundaries.",
    "cartographic violence": "The forceful enforcement of straight geometric lines onto irregular terrain, punishing bodies that inhabit the gradient.",
    "boundary reification": "The institutional transformation of an arbitrary administrative survey line into a hard physical obstacle backed by state violence.",
    
    # World 09
    "semantic annexation": "The subsumption of unique, unrepeatable subjective experiences into standardized, commodified linguistic tokens.",
    "emotional commodification": "The institutional flattening of raw personal grief into diagnostic codes and billable procedural categories.",
    "translation debt": "The irreparable epistemic deficit created when a nuanced dialect or personal experience is translated into a dominant administrative language.",
    
    # World 10
    "shared mental model": "A common cognitive framework that allows distributed actors to coordinate action without explicit ongoing communication.",
    "lexical focal point": "A default shared term that groups intuitively converge upon to coordinate behavior under incomplete information.",
    "coordination equilibrium": "The state where all participants successfully align their expectations and actions based on a shared symbolic cue.",
    
    # World 11
    "retrospective certainty": "The cognitive illusion that an ambiguous historical event was inevitable and clear-cut, constructed after the verdict is delivered.",
    "hermeneutic closure": "The final locking of an interpretation by a legal or institutional authority, extinguishing all alternative readings.",
    "forensic narrative": "A curated sequence of physical evidence assembled to justify a predetermined institutional judgment.",
    
    # World 12
    "tool breakdown": "The Heideggerian moment when a transparent, ready-to-hand tool fractures, suddenly exposing its raw material presence to consciousness.",
    "ready-to-hand": "The phenomenological transparency of a functioning tool that recedes from conscious thought during skilled, immersive use.",
    "present-at-hand": "The detached, analytical observation of a broken or isolated object after its functional immersion has collapsed.",
    
    # World 13
    "hierarchical delay": "The latency and distortion introduced when physical observations travel through multiple bureaucratic layers before reaching a decision maker.",
    "telemetric distortion": "The systemic loss of fidelity that occurs as raw field reports are summarized, sanitised, and filtered up an executive hierarchy.",
    "centralized paralysis": "The inability of an executive center to act effectively because its model of the field is perpetually out of date.",
    
    # World 14
    "hyper-compression": "The radical reduction of complex systemic ideas into slogans, pitch decks, and bullet points, sacrificing structural coherence for viral reach.",
    "rhetorical acceleration": "The pressure to optimize communication for instantaneous emotional persuasion rather than explanatory accuracy.",
    "slogan sovereignty": "The governance of institutions by catchy aphorisms that mask profound structural decay beneath crisp phrasing.",
    
    # World 15
    "goodhart's law": "When a measure becomes a target, it ceases to be a good measure, as actors game the metric at the expense of the underlying goal.",
    "metric gaming": "The strategic manipulation of measurable proxies that satisfies administrative audit while degrading actual operational competence.",
    "auditing theater": "Elaborate compliance rituals designed to satisfy numerical benchmarks while remaining entirely decoupled from physical efficacy.",
    
    # World 16
    "ungrounded data": "Information stored in archives or databases that has lost its causal indexical connection to the original physical field.",
    "epistemic orphan": "A data record whose collection methodology, sensors, and original context have been forgotten, rendering it vulnerable to hallucinated interpretations.",
    "semantic rot": "The gradual decay of meaning that occurs when symbols are repeatedly processed by algorithms with zero access to the physical ground truth.",
    
    # World 17
    "euphemism treadmill": "The linguistic cycle in which polite substitute terms inevitably absorb the negative connotations of the concepts they were invented to mask.",
    "lexical prohibition": "The institutional banning of specific words, which merely forces the taboo conceptual reality to migrate into new vocabulary.",
    "semantic evasion": "The avoidance of direct causal terminology to prevent political accountability or emotional discomfort.",
    
    # World 18
    "system invariant": "A fundamental constraint or governing law that cannot be violated without collapsing the operational viability of the entire structure.",
    "via negativa": "The epistemological method of defining and improving systems by identifying and eliminating what is fragile and false.",
    "apophatic mapping": "Describing a territory or principle strictly by mapping what it is not, avoiding the hubris of premature positive categorization.",
    
    # World 19
    "territorial drift": "The widening divergence between official geopolitical maps and the dynamic, informal trade and migration corridors on the ground.",
    "cartographic arrogance": "The institutional conviction that physical territory must conform to the lines drawn in treaties and planning documents.",
    "invisible terrain": "The living, informal networks of survival and trade that operate entirely beneath the radar of state surveillance.",
    
    # World 20
    "skin in the game": "The essential symmetry of having an inescapable personal downside when making claims or decisions that impose risk on others.",
    "downside risk": "The potential physical, financial, or reputational catastrophe that disciplines actors to respect material friction.",
    "asymmetry of risk": "The predatory dynamic where decision makers capture the upside of bold policies while transferring the catastrophic downside to vulnerable populations.",
    
    # World 21
    "reflexivity": "The circular causal loop in which participants' biased perceptions alter physical fundamentals, which in turn distort perceptions further.",
    "self-fulfilling prophecy": "A false definition of a situation that evokes a new behavior which makes the originally false conception come true.",
    "bidirectional loop": "The feedback mechanism where descriptive models actively modify the physical systems they purport to objectively describe.",
    
    # World 22
    "tacit knowledge": "Embodied, unarticulated physical know-how (Polanyi) that can only be transmitted through apprenticeship and practice, never fully encoded in text.",
    "sop limits": "The inherent boundary where written standard operating procedures fail because unpredictable physical friction demands unwritten craft intuition.",
    "craft intuition": "The unconscious mastery of material tolerances developed through thousands of hours of physical trial and tactile feedback.",
    
    # World 23
    "cognitive metaphor": "The foundational conceptual mapping (Lakoff & Johnson) through which abstract domains are understood in terms of bodily, spatial experiences.",
    "dead metaphor": "A figurative expression that has lost its metaphorical vividness through widespread use and is now treated as literal objective reality.",
    "semantic calcification": "The hardening of historical metaphors into rigid dogmatic categories that constrain institutional imagination.",
    
    # World 24
    "bit rot": "The physical degradation of digital storage media and format obsolescence that silently erases computerized cultural heritage.",
    "material permanence": "The superior long-term survival of low-tech physical inscriptions (stone, clay, parchment) compared to delicate digital storage layers.",
    "archival vulnerability": "The paradox where civilization creates more information than ever before, but on the most ephemeral substrates in human history.",
    
    # World 25
    "synthetic witness": "Algorithmic, generated, or deepfake records that mimic the indexical texture of photographic evidence without having a causal anchor in reality.",
    "causal twin": "Two identical-looking digital files that possess entirely different causal histories—one an authentic sensor trace, the other a synthetic fabrication.",
    "epistemic verification crisis": "The breakdown of public consensus on truth when media can be fabricated with indistinguishable perceptual fidelity.",
    
    # World 26
    "immutable residue": "Physical and chemical isotopes that permanently record environmental history in bone, soil, and tooth enamel, immune to rhetorical denial.",
    "forensic friction": "The inescapable material clues (mud, strontium, toolmarks) left by living bodies that contradict official passports and state alibis.",
    "biological memory": "The storage of environmental history directly within the tissue and mineral structures of living organisms.",
    
    # World 27
    "physical invariant": "An irreducible geological, thermodynamic, or biological reality that refuses to conform to political manifestos or institutional narratives.",
    "narrative resistance": "The refusal of raw physical ecology to serve as a passive backdrop or obedient metaphor for human ideological storytelling.",
    "brute matter": "The stubborn reality of gravity, frost, rock, and entropy that operates with absolute indifference to human convenience.",
    
    # World 28
    "statistical narrowing": "The algorithmic process of optimizing for majority probability distributions, which actively suppresses rare, creative, and transformative tail events.",
    "algorithmic echo": "The self-reinforcing homogenization of culture that occurs when recommendation engines feed on their own past predictions.",
    "tail event erasure": "The dangerous elimination of black swans and outlier perspectives from institutional planning models.",
    
    # World 29
    "structural debt": "Hidden compromises in core architectural integrity made to deliver a polished surface veneer on deadline.",
    "superficial completion": "The illusion that a complex system is robust and finished simply because its user interface and exterior facade look pristine.",
    "facade maintenance": "The disproportionate allocation of institutional resources toward public relations and aesthetics while core infrastructure rots.",
    
    # World 30
    "implicit promise": "An unspoken social or economic expectation built up through historical practice that creates real moral and financial claims.",
    "unwritten contract": "The tacit web of mutual obligations that stabilizes communities, whose sudden legal repudiation triggers systemic collapse.",
    "debt network": "The dense, delicate web of reciprocal social obligations that sustains human societies far more effectively than formal legal contracts.",
    
    # World 31
    "mythological anchor": "A fictionalized or legendary founding ancestor invented by a culture to legitimize its legal codes, rituals, and territorial claims.",
    "invented tradition": "A set of practices, normally governed by accepted rules, of a ritual or symbolic nature, which seek to inculcate certain values and norms by repetition (Hobsbawm).",
    "origin fiction": "The narrative construction of a pristine starting moment to provide authority and sacred stability to contemporary political power.",
    
    # World 32
    "self-binding power": "The deliberate institutional strategy (Ulysses and the Sirens) where a sovereign voluntarily constrains its own authority to generate trust and long-term stability.",
    "credible commitment": "An institutional mechanism that makes it physically or politically impossible for a leader to renege on an agreement, thereby unlocking cooperation.",
    "constitutional restraint": "The formal subordination of raw political power to impartial procedural rules that outlast individual rulers.",
    
    # World 33
    "amnesia of the crossing": "The tragic tendency of human institutions to forget that all concepts, words, and laws are lossy cuts that crossed a physical gulf, mistaking the sign for the world.",
    "the absent thing": "The living, uncompressed physical reality that cannot fit through the human mouth, which remains forever distant from the words we use to describe it.",
    "reconciliation of the sign": "The humble, mature philosophical stance that uses signs for coordination while remaining perpetually vigilant about the vast physical terrain they leave behind."
}
...
for wid in range(34):
    ...
    for term in cdata.get("terms", []):
        ...
        if key in glossary_dict:
            ...
            glossary_dict[key] = {
                "name": term.title(),
                "definition": f"Core operational dynamic and governing invariant formulated in World {wid:02d}: {cdata['title']}.",
                "world_id": wid,
...
with open("build_master_rich_marginalia_reader.py", "r", encoding="utf-8") as f:
    orig_code = f.read()

# Let's write the complete HTML template with terminal monospace marginalia drawer, zoom-in cards, and zero placeholders
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  /* ---------- Worlds 34-Card Grid with Zoomed-In Plates ---------- */
  .worlds {
  ...
  .world .fig { margin-top:auto; position:relative; height:190px; overflow:hidden; }
  .world .fig .ph { position:absolute; inset:0; }
  
  /* ZOOMED-IN CARD PLATES FOR DRAMATIC CLOSE-UP READABILITY */
  .world .fig .ph img {
    transform:scale(1.28);
    object-position:center 30%;
    transition:transform .4s ease;
    filter:grayscale(1) sepia(.20) contrast(1.16) brightness(.98);
  }
  .world:hover .fig .ph img {
    transform:scale(1.36);
  }
  .world .cap {
    position:absolute; left:.8rem; bottom:.6rem; z-index:3; font-family:var(--mono); font-size:.48rem;
    letter-spacing:.2em; color:var(--paper-hi); text-shadow:0 1px 3px rgba(0,0,0,.8);
  }
  ...
  /* HEROIC CRISP ARCHIVE PLATE: Borderless, sharp, and wide */
  ...
  .monograph-plate-image {
    ...
    filter:contrast(118%) brightness(96%) grayscale(100%) sepia(12%);
  }

  /* Sleek First Principle Aphorism Card */
  ...
  /* Interactive Concept Links in Text */
  .concept-link {
  ...
  /* ============ AUTHENTIC MONOSPACE FIELD TERMINAL DRAWER ============ */
  #side-marginalia-drawer {
    position:fixed; top:54px; right:-540px; width:500px; height:calc(100vh - 54px);
    background:#161412; color:#ede5d8; border-left:2px solid var(--red);
    box-shadow:-10px 0 40px rgba(0,0,0,.5); padding:24px 26px; z-index:350;
    overflow-y:auto; transition:right .35s cubic-bezier(0.16, 1, 0.3, 1);
    font-family:var(--mono);
  }
  #side-marginalia-drawer.open { right:0; }

  .terminal-card-section {
    background:#1f1c18; border:1px solid #36322b; padding:14px 16px;
    margin-top:14px; border-radius:3px;
  }
  .terminal-section-badge {
    display:flex; align-items:center; gap:8px;
    font-family:var(--mono); font-size:.68rem; color:var(--red); font-weight:700; letter-spacing:.15em;
    margin-bottom:8px; text-transform:uppercase; border-bottom:1px dashed #36322b; padding-bottom:4px;
  }

  .token-entity { color:#f5ad62; font-weight:bold; }
  .token-op { color:#ea6655; font-weight:bold; }
  .token-trans { color:#8ad49a; }
  .token-comment { color:#827a6e; font-style:italic; }
  ...
  .search-box-modal {
    ...
    width:90%; max-width:680px; box-shadow:0 20px 50px rgba(0,0,0,.45); padding:24px;
  }
  .search-input-field {
...
<div class="sheet">
  ...
  <div id="tab-worlds-view" class="view-panel-tab active">
    ...
    <!-- 34 WORLDS SPECIMEN CARDS (DRAMATIC CLOSE-UP ZOOM) -->
  ...
  <div id="tab-index-view" class="view-panel-tab">
    <div class="content-page-panel">
      ...
      <p class="panel-intro-lede">102 Defined Operational Invariants and Theoretical Lineages (Zero Placeholders).</p>
      
      <input type="text" id="index-filter-input" placeholder="Filter terms (e.g. Deixis, Goodhart, Tacit Knowledge, Attention Feudalism)..." 
...
<div id="side-marginalia-drawer">
  ...
  <!-- [05 :: INVARIANT ASSERTION] -->
  <div class="terminal-card-section">
    <div class="terminal-section-badge" style="color:#8ad49a;">
      [05 :: INVARIANT VALIDATION ASSERTION]
    </div>
...
<script>
  ...
  /* ============ RENDER 34 BOOK CARDS WITH DRAMATIC ZOOM ============ */
  ...
  /* ============ SYNTAX HIGHLIGHTING FOR FIELD TERMINAL DRAWER ============ */
...
print(f"Generated Terminal Monospace WORLDFUL Press App ({len(html_rendered):,} bytes)")
