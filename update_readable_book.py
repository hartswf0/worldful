...
# Detailed custom subtitles and beat headings for all 34 chapters
CHAPTERS = {
    0: {
        "title": "THE CROSSING",
        "subtitle": "How Absent Things Learned to Move Living Bodies",
        "beat1_title": "Six Wet Commas in the Mud",
        "beat2_title": "The Hunter's Trick That Scaled Into Civilization",
        "beat3_title": "The Lossy Cut and the Amnesia of Distance",
        "beat4_title": "The Zero-Shot Prompt and the Missing Gutters",
        "beat5_title": "The First Invariant: The Danger of the Clean Cut",
        "terms": ["Portable Consequence", "Lossy Cut", "Trace Authority", "Epistemic Debt"],
...
They did not. The six words were merely a trigger dropped into an ocean of training datasets, GPU compute clusters, and photographic conventions. When the generated roof line directs water straight into the digital drywall because the model never knew that rain is wet, we are shocked. We forgot that the prompt carried none of the causal obligations of real architecture.""",
    ...
    1: {
        ...
        "subtitle": "The Politics of Deixis and the Monopoly of Attention",
        "beat1_title": "The Boy Who Pointed at the Ridge",
        "beat2_title": "Deixis: The Physical Redistribution of Gaze",
        "beat3_title": "Attention Feudalism and the Licensed Finger",
        "beat4_title": "Red Badges and Algorithmic Saccades",
        "beat5_title": "The Deictic Invariant: Who Owns the Pointer",
        "terms": ["Deixis", "Salience Monopoly", "Pre-semantic Orientation", "Attention Feudalism"],
...
In product design and leadership alike, the first power is never what you say in the meeting—it is who sets the agenda items on the screen.""",
    ...
    2: {
        ...
        "subtitle": "Heritage Technical Debt and the Tyranny of Vanished Rationale",
        "beat1_title": "The Bay Window Facing an Empty Field",
        "beat2_title": "Surviving Forms in Shifting Environments",
        "beat3_title": "Priests of the Low Doorway",
        "beat4_title": "Ghost Code and Internet Explorer Wrappers",
        "beat5_title": "The Heritage Invariant: Workarounds Made Sacred",
        "terms": ["Heritage Technical Debt", "Path Dependence", "Doctrinal Residue", "Legacy Invariant"],
...
We pay a permanent latency tax on every modern request to preserve a ritual for a dead platform.""",
    ...
    3: {
        ...
        "subtitle": "Horizontal Transfer and the Myth of Pure Pedigree",
        "beat1_title": "The Shark-Beast That Learned to Clamber Up Wells",
        "beat2_title": "Reticulated Lineages and Sideways Leaks",
        "beat3_title": "Authenticity Laundering and Mythological Purity",
        "beat4_title": "Open Source Forks and Bastard Architectural Patterns",
        "beat5_title": "The Mutation Invariant: Power in Mongrel Forms",
        "terms": ["Horizontal Transfer", "Authenticity Laundering", "Reticulation", "Lineage Genome"],
...
Teams waste months debating the 'pure way' to write microservices, blind to the fact that their architecture is a bastard hybrid of pragmatic compromises borrowed from three different failed startups.""",
    ...
    4: {
        ...
        "beat1_title": "The Fireside Tiger in the Autumn Smoke",
        "beat2_title": "Loosened Stakes and the Cognitive Sandbox",
        "beat3_title": "Permanent Preparedness Paranoia",
        "beat4_title": "Red Teaming, Flight Simulators, and Model Drift",
        "beat5_title": "The Simulation Invariant: Training the Reflex",
        "terms": ["Pre-enactment", "Consequence Loosening", "Synthetic Preparedness", "Simulation Drift"],
...
The danger arises when the simulation model drifts from reality—when the financial risk model simulates every scenario except the one that actually happens, leaving the bank completely blind to the unmodeled storm.""",
    ...
    5: {
        ...
        "subtitle": "The Counts-As Rule and the Institutional Licensing of Reality",
        "beat1_title": "Firewood on the Table, Monarch on the Throne",
        "beat2_title": "Context C and the Physics of Social Contract",
        "beat3_title": "Ontological Licensing and the Tollbooth of Status",
        "beat4_title": "Memory Pointers, JWT Tokens, and Smart Contract Exploits",
        "beat5_title": "The Institutional Invariant: The Power in the Game",
        "terms": ["Counts-As Rule", "Ontological Licensing", "Jurisdictional Identity", "Institutional Reality"],
...
The catastrophe occurs when a smart contract's rule set contains a logic bug: the blockchain treats a malicious exploit as a valid legal transfer of $50 million because the code said it counted as one.""",
    ...
    6: {
        ...
        "subtitle": "High-Resolution Capture and the Semantic Blindness of Pure Telemetry",
        "beat1_title": "The Eight-Millisecond Twitch That Started a War",
        "beat2_title": "Thin Capture: Preserving the Eyelid, Losing the Wink",
        "beat3_title": "Resolutionism: The Sensor Density Delusion",
        "beat4_title": "Employee Spyware and Developer Productivity Dashboards",
        "beat5_title": "The Observational Invariant: Telemetry vs. Meaning",
        "terms": ["Thin Capture", "Resolutionism", "Hermeneutic Gap", "Observational Noise"],
...
The engineer who stares out the window for two hours and writes four lines of code that saves the company $10 million is flagged as idle, while the drone who copy-pastes boilerplate all day gets a productivity bonus.""",
    ...
    7: {
        ...
        "subtitle": "Formulary Sovereignty and the Cannibalism of the Database Schema",
        "beat1_title": "The Unlisted Spider and the Marble Steps",
        "beat2_title": "Administrative Ontology: Power Disguised as Furniture",
        "beat3_title": "Formulary Sovereignty and Administrative Cannibalism",
        "beat4_title": "ICD-10 Codes, EHR Burnout, and Rigid CRM Schemas",
        "beat5_title": "The Schema Invariant: The Reality Outside the Box",
        "terms": ["Formulary Sovereignty", "Administrative Cannibalism", "Administrative Ontology", "Unstructured Residue"],
...
The software system cannibalizes clinical intuition, turning healing into data entry.""",
    ...
    8: {
        ...
        "subtitle": "Cartographic Leviathans and the Violent Friction Between Geometry and Mud",
        "beat1_title": "Cedar Stakes in the Shifting Silt",
        "beat2_title": "Artificial Discontinuity Driven Through a Gradient",
        "beat3_title": "The Cartographic Leviathan and Surveyors' Hubris",
        "beat4_title": "Microservice Boundaries and Tribal Architecture Wars",
        "beat5_title": "The Boundary Invariant: How Paper Conquers Earth",
        "terms": ["Cartographic Leviathan", "Enforced Discontinuity", "Surveyor's Hubris", "Continuous Gradient"],
...
In reality, user authentication and payment workflows are deeply intertwined. The teams spend 50% of their engineering sprint cycles fighting over API boundaries and network serialization latency, bleeding money to maintain an arbitrary line drawn on a whiteboard.""",
    ...
    9: {
        ...
        "beat1_title": "The Loom Beside Yours That Stopped Forever",
        "beat2_title": "Reconstruction Under Unequal Gravity",
        "beat3_title": "Emotional Commodification and Standardized Settlements",
        "beat4_title": "Six Emoji Reactions for the Whole Human Soul",
        "beat5_title": "The Translation Invariant: The Unpayable Private Debt",
        "terms": ["Semantic Annexation", "Inequal Gravity", "Residual Incommensurability", "Emotional Commodification"],
...
The software annexes your interiority, forcing your unique human moment into an aggregated metric optimized for ad retargeting.""",
    ...
    10: {
        ...
        "beat1_title": "The Pebble on the Courtyard Wall",
        "beat2_title": "The Illusion of Shared Paint and Coordinative Sufficiency",
        "beat3_title": "Alignment Theater and the Inquisition of Interiority",
        "beat4_title": "Microservice JSON Contracts and Generative AI Latent Space",
        "beat5_title": "The Coordination Invariant: The Shared Pebble",
        "terms": ["Coordinative Equivalence", "Prototype Flattening", "Alignment Theater", "Shared Mental Model"],
...
2. **The Generative Prompt:** When you type *"a dramatic portrait of an ancient king"* into an AI image model, you and the neural network have zero shared consciousness. The model has no concept of kings, drama, or antiquity; it has only multi-dimensional statistical weight distributions. Yet the generated image lands close enough to your intent that you download it. You have thrown a text prompt like a pebble, and the model has startled the bird you meant.""",
    ...
    11: {
        ...
        "beat1_title": "Three Blue Glazed Shards in the Latrine",
        "beat2_title": "The Biological Craving for Narrative Closure",
        "beat3_title": "Retrospective Certainty Inflation and Mythic Destinies",
        "beat4_title": "Post-Mortem Root Cause Analysis and Plaster Narratives",
        "beat5_title": "The Archaeological Invariant: The Storyteller's Glue",
        "terms": ["Hermeneutic Glue", "Fragment Inflation", "Epistemic Restraint", "Retrospective Certainty"],
...
In reality, sixteen different distributed micro-events (network packet drops, garbage collection pauses, third-party API latency) coincided simultaneously. The tidy 'Root Cause' document is just plaster glue designed to reassure executive leadership.""",
    ...
    12: {
        ...
        "subtitle": "Phenomenological Transparency and the Shock of Infrastructure Breakdown",
        "beat1_title": "The Ash Handle Snapped in the Carpenter's Palm",
        "beat2_title": "Ready-to-Hand vs. Present-at-Hand: The Disappearing Instrument",
        "beat3_title": "Infrastructural Starvation and the Ribbon-Cutting Bias",
        "beat4_title": "Open-Source Maintainers in Nebraska and Log4j Shocks",
        "beat5_title": "The Infrastructural Invariant: Transparent Scaffolding",
        "terms": ["Ready-to-Hand (Zuhandenheit)", "Present-at-Hand (Vorhandenheit)", "Infrastructural Invisibility", "Tool Breakdown"],
...
Nobody notices or pays the volunteer until a critical Zero-Day vulnerability (like Log4j) crashes the global internet. Suddenly, five thousand panicked enterprise executives are forced to learn what the library does.""",
    ...
    13: {
        ...
        "subtitle": "Scale Inversion, Bureaucratic Latency, and the Loss of Bodily Presence",
        "beat1_title": "The Forty-Mile Emperor and the Dead Villager",
        "beat2_title": "The Physics of Latency in Giant Distributed Hierarchies",
        "beat3_title": "Sensory Decoupling and the Cold Palace of Memos",
        "beat4_title": "Automated Help Desks and 90-Day Ticket Loops",
        "beat5_title": "The Scaling Invariant: When the Head Forgets the Feet",
        "terms": ["Bureaucratic Latency", "Sensory Decoupling", "Scale-Induced Inertia", "Hierarchical Delay"],
...
The giant has moved its toe after the village has already starved.""",
    ...
    14: {
        ...
        "beat1_title": "Forty Seconds to Explain Quantum Gravity",
        "beat2_title": "Hyper-Compression and the Stripping of Boundary Conditions",
        "beat3_title": "Executive Seduction: Confusing Brevity with Wisdom",
        "beat4_title": "Startup Pitch Decks and the $500M Slogan Collapse",
        "beat5_title": "The Compression Invariant: Portable Slogans, Crashing Physics",
        "terms": ["Lossy Seduction", "Boundary Stripping", "Executive Mutilation", "Hyper-Compression"],
...
When the company inevitably collapses because real healthcare regulations and legal liabilities cannot be solved with an iPhone app, everyone acts astonished. They bought the elevator pitch and forgot the physics.""",
    ...
    15: {
        ...
        "subtitle": "Goodhart's Law and the Tyranny of the Scored Target",
        "beat1_title": "The Sawdust Bread That Hit 1,000% Production Target",
        "beat2_title": "Goodhart's Law: When the Metric Destroys the Goal",
        "beat3_title": "Metric Gamification and the Erasure of Craftsmanship",
        "beat4_title": "Call Center Hang-Ups and Trivial JIRA Velocity Points",
        "beat5_title": "The Quantitative Invariant: The Starvation of Quality",
        "terms": ["Goodhart's Law", "Metric Gaming", "Qualitative Erasure", "Goodhart's Horizon"],
...
The dashboard shows record velocity while the product collapses.""",
    ...
    16: {
        ...
        "subtitle": "Dossier Governance and the Weaponization of Naked Facticity",
        "beat1_title": "The Tavern Play Prop That Put John in the Dungeon",
        "beat2_title": "Naked Facticity: Ink Preserved, Soul Erased",
        "beat3_title": "Dossier Governance and Unappealable Credit Blacklists",
        "beat4_title": "Twitter Excavations from 2011 and LLM Sarcasm Ingestion",
        "beat5_title": "The Archival Invariant: Inscription vs. Truth",
        "terms": ["Dossier Governance", "Provenance Stripping", "Naked Facticity", "Ungrounded Data"],
...
Similarly, LLMs scrape sarcastic Reddit threads and fictional forum posts, ingesting them as literal ground truth about human history and physics.""",
    ...
    17: {
        ...
        "beat1_title": "The Banned Word Hunger and the Blue Ribbon Dance",
        "beat2_title": "Meaning as Liquid: The Sieve of Official Prohibitions",
        "beat3_title": "The Censorship Industrial Complex and Universal Paranoia",
        "beat4_title": "TikTok Algospoke and Corporate Layoff Euphemisms",
        "beat5_title": "The Taboo Invariant: Meaning Dancing in the Dark",
        "terms": ["Subterranean Migration", "Taboo Friction", "Algospoke", "Euphemism Treadmill"],
...
Meanwhile, corporate HR departments invent new sanitized euphemisms for layoffs (*'workforce right-sizing'*, *'talent recalibration'*), fooling no one while degrading the honesty of language.""",
    ...
    18: {
        ...
        "beat1_title": "The Beast That Left No Track in the Dunes",
        "beat2_title": "Apophasis: When Direct Nouns Are Dangerous Traps",
        "beat3_title": "Apophatic Paralysis and the Purity of Inaction",
        "beat4_title": "API Invariant Specifications and Security Boundaries",
        "beat5_title": "The Negative Invariant: Carving the Boundary",
        "terms": ["Apophasis", "Negative Space Modeling", "Boundary Sculpting", "System Invariant"],
...
By carving out the forbidden negative space, the system allows infinite creative freedom within safe boundaries.""",
    ...
    19: {
        ...
        "beat1_title": "The Hundred-Mile Map and the Desert of Bleached Bones",
        "beat2_title": "Simulacrum Dominance: When the Map Replaces the Ground",
        "beat3_title": "Dashboard Blindness in the C-Suite",
        "beat4_title": "Algorithmic Redlining and Synthetic ESG Scores",
        "beat5_title": "The Cartographic Invariant: The Soil Audits the Map",
        "terms": ["Cartographic Annexation", "Simulacrum Dominance", "Dashboard Blindness", "Territorial Drift"],
...
The bank manages its loan portfolio by looking at the credit score map, entirely divorced from the real creditworthiness of the human beings on the ground.""",
    ...
    20: {
        ...
        "subtitle": "Operational Liability and the Structural Restoration of Truth",
        "beat1_title": "The Wicker Basket and the Pit Viper's Strike",
        "beat2_title": "Why Cheap Talk Destroys Epistemic Health",
        "beat3_title": "The Decoupled Punditry Class",
        "beat4_title": "Licensed Structural Engineering Seals and Smart Contract Slashing",
        "beat5_title": "The Liability Invariant: Weight in the Sentence",
        "terms": ["Operational Liability", "Skin in the Game", "Binding Utterance", "Downside Risk"],
...
Similarly, decentralized finance protocols lock cryptocurrency in escrow that is automatically slashed if an oracle feed proves the validator lied.""",
    ...
    21: {
        ...
        "subtitle": "Reflexivity and Descriptions That Construct Their Own Reality",
        "beat1_title": "The Wandering Monk and the Blacksmith's Forge",
        "beat2_title": "Reflexivity: When the Prediction Evokes the Behavior",
        "beat3_title": "Contagious Diagnosis and Manufacturing Pathology",
        "beat4_title": "Bank Runs, Flash Crashes, and Recommender Feedback Loops",
        "beat5_title": "The Reflexive Invariant: The Mirror That Builds the Room",
        "terms": ["Reflexivity", "Self-Fulfilling Prophecy", "Contagious Diagnosis", "Bidirectional Loop"],
...
The tweet was not reporting an existing bankruptcy; the tweet created the bankruptcy.""",
    ...
    22: {
        ...
        "beat1_title": "The Thousand-Page Manual and the Wet Mud Pancake",
        "beat2_title": "We Know More Than We Can Tell: Polanyi's Tacit Frontier",
        "beat3_title": "Taylorism and the Illusion of Documented Mastery",
        "beat4_title": "Senior Engineer Heuristics and System Scent",
        "beat5_title": "The Craft Invariant: Mud Pushing Back",
        "terms": ["Tacit Knowledge", "Somatic Calibration", "Productive Collapse", "SOP Limits"],
...
She cannot fully explain how she knew; her brain matched fifty subtle historical failure patterns simultaneously.""",
    ...
    23: {
        ...
        "beat1_title": "The Ox Carved on the Stone Coin",
        "beat2_title": "The Bodily Origins of Abstract Cognition",
        "beat3_title": "The Dogma of the Dead Sign",
        "beat4_title": "Floppy Disk Save Icons and Desktop Trash Cans",
        "beat5_title": "The Metaphor Invariant: Remembering the Living Muscle",
        "terms": ["Dead Metaphor", "Semantic Fossilization", "Visceral Amnesia", "Cognitive Metaphor"],
...
These 1970s office furniture metaphors now constrain how we conceptualize non-linear, multi-dimensional digital knowledge graphs.""",
    ...
    24: {
        ...
        "beat1_title": "The Stainless Steel Plaque and the Shovel Cult",
        "beat2_title": "Survivorship Bias: The Hardness of the Rock vs. the Truth of the Voice",
        "beat3_title": "Archival Aristocracy and the Neglect of Living Needs",
        "beat4_title": "Digital Bit Rot and the 21st-Century Historical Blackout",
        "beat5_title": "The Archival Invariant: Never Confuse Durability with Wisdom",
        "terms": ["Survivorship Bias", "Deep-Time Inscription", "Archival Aristocracy", "Bit Rot"],
...
Future historians will know more about ancient Roman tax receipts than about the birth of the internet.""",
    ...
    25: {
        ...
        "beat1_title": "Two Identical Red Coats in the Burning Smoke",
        "beat2_title": "Causal History as the True Well of Value",
        "beat3_title": "Authenticity Laundering and the Synthetic Trust Parasite",
        "beat4_title": "Generative AI Deepfakes and the Erosion of Photographic Witness",
        "beat5_title": "The Provenance Invariant: Pixels vs. Encounters",
        "terms": ["Causal History", "Authenticity Rent", "Surface Mimicry", "Synthetic Witness"],
...
As synthetic content drowns the internet, public trust collapses entirely: citizens stop believing real photographs of real atrocities, dismissing actual human suffering as 'just another AI render.'""",
    ...
    26: {
        ...
        "subtitle": "Material Resistance as the Incorruptible Counter-Narrative to Power",
        "beat1_title": "The Yellow Sediment on the Prime Minister's Tires",
        "beat2_title": "Why Mud and Isotopes Cannot Be Spun",
        "beat3_title": "The Permanent Suspicion Industry and Evidentiary Flooding",
        "beat4_title": "Git Blame Trails and Cryptographic Database Logs",
        "beat5_title": "The Forensic Invariant: Matter Refuses to Flatter the King",
        "terms": ["Forensic Witness", "Unintentional Inscription", "Adversarial Trust", "Immutable Residue"],
...
The machine telemetry destroys the executive’s PR narrative instantly.""",
    ...
    27: {
        ...
        "beat1_title": "Ten Thousand Bronze Shields Beneath Sixty Feet of Scree",
        "beat2_title": "The Cosmic Indifference of Geology and Physics",
        "beat3_title": "Representation Hubris and Political Delusions",
        "beat4_title": "Theranos, Battery Chemistry, and the Limits of Storytelling",
        "beat5_title": "The Material Invariant: The Unyielding Audit of Nature",
        "terms": ["Material Indifference", "Representation Hubris", "Real-World Audit", "Physical Invariant"],
...
You can fool venture capitalists with storytelling, but blood chemistry physics does not read slide decks. The machine failed every test.""",
    ...
    28: {
        ...
        "subtitle": "Autocomplete Culture and the Benevolent Capture of Human Agency",
        "beat1_title": "The Royal Scribe That Finished the King's Sentences",
        "beat2_title": "The Seduction of Convenience: How Suggestions Narrow Thought",
        "beat3_title": "Autocomplete Atrophy and the Loss of Original Expression",
        "beat4_title": "AI Copilots, Boilerplate Synthesis, and Algorithmic Lock-In",
        "beat5_title": "The Agency Invariant: The Velvet Handcuffs of Autocomplete",
        "terms": ["Benevolent Capture", "Inference Steering", "Autocomplete Atrophy", "Statistical Narrowing"],
...
Over time, developers stop learning the deep fundamentals of system architecture, relying entirely on the model’s suggestions. When a novel problem arises that does not exist in the training data, the developer is paralyzed.""",
    ...
    29: {
        ...
        "beat1_title": "Fourteen Days to Build a Palace, Three Hours to Drown It",
        "beat2_title": "The Stage Lighting Bias: Surface Appearance vs. Operational Debt",
        "beat3_title": "Aesthetic Fraud and the Celebration of Vaporware",
        "beat4_title": "Viral AI Video Prototypes and 40% Edge-Case Failure Rates",
        "beat5_title": "The Architectural Invariant: The Rain Test",
        "terms": ["Demo Colonialism", "The Rain Test", "Aesthetic Fraud", "Structural Debt"],
...
When real users try the software on messy real-world data, the agent hallucinations fail on edge cases 40% of the time, booking flights for the wrong year and deleting user databases. The demo was exquisite; the roof had no flashing.""",
    ...
    30: {
        ...
        "subtitle": "Category Arbitrage and the Invisible Obligations Packed into Ordinary Nouns",
        "beat1_title": "The Carpenter Sentenced to Carry His Broken Chair",
        "beat2_title": "Noun Debts: What Labels Owe the Physical World",
        "beat3_title": "Category Arbitrage and the Theft of Prestigious Names",
        "beat4_title": "Software API Contracts and Unbacked Persistent IO",
        "beat5_title": "The Semantic Invariant: Keeping Nouns Honest",
        "terms": ["Noun Debt", "Category Arbitrage", "Relational Integrity", "Implicit Promise"],
...
The name promised durability; the implementation delivered an unbacked IO debt.""",
    ...
    31: {
        ...
        "subtitle": "Synthetic Trust Farming and the Untarnishable Authority of Myth",
        "beat1_title": "The Sealed Confession in the Archival Vault",
        "beat2_title": "Why Phantoms Make the Most Stable Institutional Anchors",
        "beat3_title": "The Untarnishable Icon and the Tyranny of Dead Ghosts",
        "beat4_title": "Betty Crocker, Brand Mascots, and Synthetic AI Influencers",
        "beat5_title": "The Mythological Invariant: The Safety of the Phantom",
        "terms": ["Synthetic Trust Farming", "Retrospective Legitimacy", "The Untarnishable Icon", "Mythological Anchor"],
...
Today, corporations launch synthetic AI influencers with algorithmically generated life stories to sell luxury fashion, creating pitch-perfect commercial avatars that will never age, get arrested, or express an unapproved political opinion.""",
    ...
    32: {
        ...
        "beat1_title": "The Hundred Thousand Knights and the Blindfolded Magistrate",
        "beat2_title": "The Curtain Contract: Power Submitting to Its Own Theater",
        "beat3_title": "Frame Laundering and the Hypocrisy of Sham Justice",
        "beat4_title": "Constitutional Restraint and OS Kernel Access Sandboxes",
        "beat5_title": "The Procedural Invariant: When the Crown Turns Back to Lead",
        "terms": ["Modality Laundering", "The Curtain Contract", "Procedural Restraint", "Self-Binding Power"],
...
In computer operating systems, the root administrative kernel voluntarily subjects itself to strict cryptographic access controls and sandboxing protocols to prevent accidental system destruction.""",
    ...
    33: {
        "title": "THE RED BIRD WORLD",
        "subtitle": "Coordination Across the Irreducible Gap (Conclusion & Meta-WorldText)",
        "beat1_title": "The Scarlet Word Across the Silicon Chasm",
        "beat2_title": "Sealed Nervous Systems and the Operating System of Civilization",
        "beat3_title": "The Amnesia of the Crossing: Forgetting the Mud",
        "beat4_title": "Trillions of Dollars and Global Codebases Built on Lossy Strings",
        "beat5_title": "The Final Invariant: The Miracle of the Absent Bird",
        "terms": ["The Absent Bird", "Sealed Nervous Systems", "WorldText", "Amnesia of the Crossing"],
...
def generate_all():
    print("Regenerating all 34 book chapters with evocative subtitles, custom beat headings, and cross-links...")
    
    # 1. Generate individual chapter files
    for wid in range(34):
        cdata = CHAPTERS[wid]
        ...
        with open(filepath, 'w', encoding='utf-8') as f:
            ...
            f.write("### 🔑 Core Concepts in This World\n\n")
        ...
        print(f"  [Enhanced Chapter] {filename}")

    # 2. Build dedicated Glossary Appendix File
    glossary_filepath = OUTPUT_DIR / "34_master_glossary_and_index.md"
    all_terms = build_master_glossary(glossary_filepath)
    
    # 3. Build master combined single-volume book
    build_complete_book_volume(all_terms)
    
    # 4. Build master README for readable_book
    build_readable_readme()

def build_master_glossary(glossary_path):
    print("Building comprehensive Master Glossary with Hyperlinks...")
    from enhance_books import PRAGMATIC_METADATA
    
    all_terms = {}
    for wid, cdata in CHAPTERS.items():
        wname = f"{wid:02d}. {cdata['title']}"
        slug = re.sub(r'[^a-zA-Z0-9]+', '_', cdata['title']).strip('_').lower()
        fname = f"{wid:02d}_{slug}.md"
        anchor = f"#{wid:02d}-{slug.replace('_', '-')}"
        
        meta = PRAGMATIC_METADATA.get(wid, {})
        for term, desc in meta.get("key_terms", {}).items():
            if term not in all_terms:
                all_terms[term] = {
                    "definition": desc,
                    "chapters": []
                }
            all_terms[term]["chapters"].append((wid, cdata['title'], fname, anchor))
            
    with open(glossary_path, 'w', encoding='utf-8') as f:
        f.write("# MASTER GLOSSARY & HYPERLINKED CONCEPT INDEX\n\n")
        f.write("> An alphabetical index of all core philosophical, cybernetic, sociological, and computational terms defined across the 33 worlds, with direct hyperlinks to their primary chapters.\n\n---\n\n")
        
        for term in sorted(all_terms.keys()):
            tdata = all_terms[term]
            term_slug = re.sub(r'[^a-zA-Z0-9]+', '-', term).strip('-').lower()
            f.write(f"### <a id=\"{term_slug}\"></a>`{term}`\n\n")
            f.write(f"**Definition:** {tdata['definition']}\n\n")
            f.write("**Referenced In:**\n")
            for wid, title, fname, _ in tdata['chapters']:
                f.write(f"- [World {wid:02d}: {title}](file://./{fname})\n")
            f.write("\n---\n\n")
            
    print(f"  [Glossary Complete] {glossary_path.name} ({len(all_terms)} terms indexed)")
    return all_terms

def build_complete_book_volume(all_terms):
    ...
    with open(master_path, 'w', encoding='utf-8') as mf:
        ...
        # Append Master Glossary at the end of the compiled volume
    ...
    print(f"  [Complete Volume Ready] {master_path.name} ({os.path.getsize(master_path):,} bytes)")

def build_readable_readme():
    readme_path = OUTPUT_DIR / "README.md"
    with open(readme_path, 'w', encoding='utf-8') as f:
        f.write("# THE ABSENT THING — READABLE BOOK DIRECTORY\n\n")
        f.write("> *33 Worlds of Description, Distance, and Power*\n\n")
        f.write("This directory contains the completely synthesized, non-redundant, narrative chapters of the book.\n\n")
        f.write("### 📖 Complete Single-Volume File\n")
        f.write("- [**THE_ABSENT_THING_COMPLETE_BOOK.md**](file://../THE_ABSENT_THING_COMPLETE_BOOK.md) — *The complete compiled volume with hyperlinked Table of Contents and Master Glossary.*\n\n")
        f.write("### 📚 Hyperlinked Master Glossary\n")
        f.write("- [**34_master_glossary_and_index.md**](file://./34_master_glossary_and_index.md) — *Alphabetical index of 102 terms cross-linked to every chapter.*\n\n")
        f.write("### 📑 Chapters\n\n")
        f.write("| Chapter | Title | Subtitle | File |\n")
        f.write("| :---: | :--- | :--- | :--- |\n")
        for wid in range(34):
            cdata = CHAPTERS[wid]
            slug = re.sub(r'[^a-zA-Z0-9]+', '_', cdata['title']).strip('_').lower()
            fname = f"{wid:02d}_{slug}.md"
            f.write(f"| **{wid:02d}** | **{cdata['title']}** | *{cdata['subtitle']}* | [{fname}](file://./{fname}) |\n")
