...
# Load exhaustive definitions and chapters data
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  /* MACRO ZOOM ON THUMBNAILS FOR DRAMATIC ENGRAVING LEGIBILITY */
  .world .fig .ph img {
  ...
  /* =========================================================
     MOBILE REFLOW: ZERO OVERLAPS, CLEAN HERO, SINGLE-ROW NAV
     ========================================================= */
  @media (max-width:960px) {
    .marginalia { display:none; }
    
    /* Clean, sleek single-row mobile header (No stacked chart junk) */
    header.site-header {
      padding:1rem 1.2rem;
      display:flex;
      align-items:center;
    ...
    /* Mobile Hero Column Layout — ZERO OVERLAPPING */
    .hero {
      display:flex;
    ...
    .thesis { font-size:1.05rem; line-height:1.6; letter-spacing:.22em; }
    .lede { font-size:1.15rem; line-height:1.5; margin-top:1.2rem; }
    .cta { width:100%; justify-content:center; margin-top:1.8rem; }
    .route { display:none; }

    /* Hide colliding desktop absolute scraps on mobile and place a clean curated mobile hero stage */
    .piece.moai-strip,
    .piece.map-left,
    .piece.bird,
    .piece.fieldnote,
    ...
    /* Clean Mobile Hero Artwork Plate (Clean, prominent, zero collisions) */
    .mobile-hero-curated-stage {
    ...
    .mobile-hero-curated-stage img {
      width:100%;
      height:220px;
      object-fit:cover;
      display:block;
      filter:contrast(112%) brightness(98%) grayscale(100%) sepia(16%);
    }
  ...
  .mobile-hero-curated-stage { display:none; }
</style>
</head>
<body>
<div class="sheet">
  ...
  <div id="tab-worlds-view" class="view-panel-tab active">
    ...
    <section class="hero">
      ...
      <div class="hero-left">
        ...
        <!-- Clean Mobile Hero Stage (Zero Overlap) -->
        <div class="mobile-hero-curated-stage">
          <img src="readable_book/assets/images/plate_00.png" alt="Opening Archival Pass">
          <div style="font-family:var(--mono); font-size:.62rem; color:var(--ink-soft); margin-top:6px; letter-spacing:.15em;">
            PLATE 0 &bull; THE CROSSING &bull; FIELD STATION ARCHIVE
          </div>
        </div>
      </div>

      <!-- Desktop Hero Scraps (Hidden on Mobile to Prevent Collisions) -->
...
print(f"Generated Mobile Perfect WORLDFUL Press Application ({len(html_rendered):,} bytes)")
